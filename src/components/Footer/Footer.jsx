      ...
      <div className="footer__content">
        <div className="footer__inner">
          ...
          <div className="footer__contact">
            <p className="footer__text">+91 733 807 6770</p>
            <p className="footer__text">suhatikasarees@gmail.com</p>
          </div>
          <div className="footer__address">
            <p className="footer__text">8425 COASTAL COMMERCE BLVD, SUITE 310,</p>
            <p className="footer__text">TAMPA, FL 33619</p>
            <p className="footer__text">United States</p>
          </div>
          <div className="footer__legal">
            <a href="/terms" className="footer__link">TERM & CONDITIONS</a>
            <a href="/privacy" className="footer__link">Privacy & Policy's</a>
          </div>
        </div>
      </div>
