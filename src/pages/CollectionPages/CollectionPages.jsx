      ...
      <main className="collection-pages__main">
        ...
        <section className="collection-pages__discover">
          <div className="collection-pages__discover-inner">
            <h2 className="collection-pages__discover-title">Discover Our Exquisite Silk Collections</h2>
            <p className="collection-pages__discover-text">
              Each collection is thoughtfully curated to celebrate the richness of tradition and the elegance of modern design. From vibrant
              festive hues to timeless wedding classics, our silk sarees are crafted to make every occasion unforgettable.
            </p>
            <p className="collection-pages__discover-text">
              Every piece reflects fine craftsmanship, luxurious texture, and intricate detailing — designed for women who appreciate
